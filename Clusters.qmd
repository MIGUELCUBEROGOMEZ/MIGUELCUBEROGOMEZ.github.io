...
suppressMessages({
    suppressWarnings({
      install.packages(c("skimr", "corrplot", "Rtsne", "cluster", "kernlab", "skmeans", "ggplot2", "dplyr", "DescTools", "irlba", "Matrix", "leaflet", "tidyverse", "factoextra", "data.table", "rgl", "magick", "rglwidget", "meanShiftR"))
